...
_PARSE_PROMPT = (
    ...
    "  IMPORTANT: Taiwan brokerage statements (對帳單/成交回報) often show ONLY "
    "  the Chinese company name (股票名稱) with NO numeric code — e.g. \"優群\", "
    "  \"台積電\", \"聯發科\". In that case, resolve the company's official "
    "  listed code yourself (優群→3217, 台積電→2330, 聯發科→2454) and use that "
    "  as ticker; put the original name in notes. Only omit the row if you "
    "  genuinely cannot identify the company's code with confidence.\n"
    "- type: \"buy\" for 買進/現股買進/Buy, \"sell\" for 賣出/現股賣出/Sell.\n"
